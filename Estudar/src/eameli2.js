...
var btn = `
<div id="novai-main-metrics" data-nvai-component="main">
    ...
    function o() {
      if (null != verif && "pro" == verif) {
        ...
        document.addEventListener("VisitsDataResponse", T), function () {
          ...
          const existingMainMetrics = document.getElementById("novai-main-metrics");
          existingMainMetrics && existingMainMetrics.remove();
        ...
        const existingMainMetrics = document.getElementById("novai-main-metrics");
        existingMainMetrics && existingMainMetrics.remove();
        spot[0].insertAdjacentHTML("afterbegin", btn);
      })()
    }
