...
function contentScpt() {
  ...
  function t() {
    ...
    (function bindNovaiChartHover() {
      const e = document.getElementById("novai-fat-card"), t = document.getElementById("novai-chart-panel");
      if (!e || !t) return;
      const n = a => {
        const i = a.clientX + 12, s = a.clientY - (t.offsetHeight + 12);
        t.style.left = i + "px", t.style.top = Math.max(8, s) + "px"
      };
